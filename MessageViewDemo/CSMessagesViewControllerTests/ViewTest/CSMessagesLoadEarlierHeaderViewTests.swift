...
class CSMessagesLoadEarlierHeaderViewTests: XCTestCase
{
	override func setUp()
	{
		super.setUp()
	...
	{
		let headerView: UINib! = CSMessagesLoadEarlierHeaderView.nib()
		XCTAssertNotNil(headerView, "Nib should not be nil")

		let headerId: String! = CSMessagesLoadEarlierHeaderView.headerReuseIdentifier()
