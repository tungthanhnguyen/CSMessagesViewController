...
class CSMessagesTypingIndicatorFooterViewTests: XCTestCase
{
	override func setUp()
	{
		super.setUp()
	...
	{
		let footerView: UINib! = CSMessagesTypingIndicatorFooterView.nib()
		XCTAssertNotNil(footerView, "Nib should not be nil")

		let footerId: String! = CSMessagesTypingIndicatorFooterView.footerReuseIdentifier()
